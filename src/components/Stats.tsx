    ...
    return (
        ...
        >
            <div className="flex items-baseline gap-1">
                <span className="text-4xl lg:text-5xl font-black text-slate-900 group-hover:text-db-teal transition-colors duration-300">
                    {count}
                </span>
                <span className="text-2xl lg:text-3xl font-black text-db-teal">
                    {suffix}
                </span>
            </div>
        ...
        <div className="relative w-full aspect-square max-w-[500px] mx-auto">
            ...
            <svg viewBox="0 0 400 400" className="w-full h-full relative z-10">
                ...
                <motion.circle
                    ...
                    cx="265" cy="110" r="15" className="fill-teal-500"
                />
                ...
                {[
                    { x: 80, h: 60, delay: 0.2 },
                    { x: 130, h: 100, delay: 0.4 },
                    { x: 180, h: 140, delay: 0.6 },
                    { x: 230, h: 180, delay: 0.8 }
                ].map((bar, i) => (
                    <motion.rect
                        key={i}
                        ...
                        className="fill-teal-700 opacity-80"
                    />
                ))}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div>
                        ...
                        >
                            <div className="flex -space-x-3">
                                ...
                                <div className="w-10 h-10 rounded-full border-2 border-white bg-teal-500 flex items-center justify-center text-white text-[10px] font-black">
                                    500+
                                </div>
                            </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-slate-100/50 rounded-full blur-[100px] -z-10" />
                    </div>
